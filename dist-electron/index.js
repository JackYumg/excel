...
(function(module, exports) {
  (function(root) {
    ...
    var handleTrailingCharacters = function(string) {
      return string.replace(/\x20$/, "=20").replace(/\t$/, "=09");
    };
    ...
    if (freeExports && !freeExports.nodeType) {
      if (freeModule) {
        freeModule.exports = quotedPrintable2;
      } else {
        for (var key in quotedPrintable2) {
          quotedPrintable2.hasOwnProperty(key) && (freeExports[key] = quotedPrintable2[key]);
        }
      }
    } else {
      root.quotedPrintable = quotedPrintable2;
    }
  })(commonjsGlobal);
})(quotedPrintable, quotedPrintable.exports);
quotedPrintable.exports;
var utf8 = {};
...
(function(exports) {
  (function(root) {
    ...
    var byteCount;
    var byteIndex;
    function utf8decode2(byteString) {
    ...
    root.decode = utf8decode2;
  })(exports);
})(utf8);
set_fs(fs);
const reaFile = (path2) => {
  const e = fs.readFileSync(path2);
  return e;
};
const menus = new electron.Menu();
const addMenu = (app2, win) => {
  menus.append(new electron.MenuItem({
    label: "文件",
    role: "fileMenu",
    submenu: [{
      label: "打开",
...
function createWindow() {
  ...
  ipcMain.on("sendMessage", (event, title) => {
    ...
    win == null ? void 0 : win.setTitle(title);
  });
  if (app.isPackaged) {
    mainWindow.loadFile(path.join(__dirname, "./../dist/index.html"));
  } else {
    let url = "http://localhost:4300";
